class ApplicationController < ActionController::Base
  ...
  # devise_parameter_sanitizer.permit(:sign_up, keys: [:first_name, :last_name, :mobile_number,:position,:country_code,:time_zone, :country, :organisation, :t_c_accepted, :flag])
    devise_parameter_sanitizer.permit(:sign_up, keys: [:first_name, :last_name, :mobile_number,:position,:country_code,:time_zone, :country, :organisation,:user_type])
    devise_parameter_sanitizer.permit(:account_update, keys: [:first_name, :last_name, :mobile_number,:position,:country_code,:time_zone, :country, :organisation,:user_type])
  end
